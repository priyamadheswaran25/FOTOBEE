...
export const CandidPhotography: React.FC = () => {
  ...
  const captureList = [
    {
      ...
      desc: "True emotions and genuine smiles captured without posing.",
      icon: Smile
    },
    {
      num: "02",
      title: "Emotional Tears",
      desc: "Tears of joy and heartfelt expressions during key rituals.",
      icon: Heart
    },
    {
      num: "03",
      title: "Guest Laughter",
      desc: "Joyous candid moments shared among family and friends.",
      icon: Users
    },
    {
      num: "04",
      title: "Behind-The-Scenes",
      desc: "Quiet moments and preparations before the main celebrations.",
      icon: Camera
    },
    {
      num: "05",
      title: "Couple Chemistry",
      desc: "Unscripted side-glances and natural interactions between the couple.",
      icon: User
    },
    {
      num: "06",
      title: "Playful Teasing",
      desc: "Fun interactions between cousins and close friends.",
      icon: Sparkles
    },
    {
      num: "07",
      title: "Elders' Blessings",
      desc: "Quiet, emotional blessings from grandparents and elders.",
      icon: Gift
    },
    {
      num: "08",
      title: "Celebration Highs",
      desc: "Vibrant moments during the dance, games and feasts.",
      icon: Stars
    }
  ];
  ...
  const galleryImages = [
    { src: "/collage-bridesmaids.jpg", caption: "Laughter shared among bridesmaids", category: "Bridesmaids" },
    { src: "/arun-priya-swing.jpg", caption: "Giggles on the Oonjal swing", category: "Candid Couple" },
    { src: "/arun-priya-rice.jpg", caption: "Playful throwing of sacred rice", category: "Muhurtham" },
    { src: "/arun-priya-garlands.jpg", caption: "Exciting moment of garland exchange", category: "Garland Exchange" },
    { src: "/arun-priya-holding.jpg", caption: "Tight clasp of hands during vows", category: "Details" },
    { src: "/collage-kolam.jpg", caption: "Quiet family preparation moment", category: "Family Blessings" }
  ];
    ...
    <div className="w-full bg-cream relative paper-texture overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-32 pb-4 text-left">
        <nav className="text-xs tracking-widest uppercase font-bold text-mud/50 space-x-2">
          ...
          <span>&gt;</span>
          <span className="text-terracotta">Candid Photography</span>
        </nav>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            <p className="font-tamil font-normal text-base md:text-lg text-mud/80 border-l-2 border-terracotta/30 pl-4 py-1 leading-relaxed">
              “உணர்ச்சிகள் பொங்கும் தருணங்களை,<br />
              இயல்பாகப் படம் பிடிக்கும் கலை.”
            </p>

            <p className="font-sans text-sm sm:text-base text-mud/85 leading-relaxed max-w-lg">
              Natural emotions, genuine smiles, and unexpected moments—our candid photography captures your special memories as they truly happen.
            </p>
          ...
          {/* Right Column: Large Featured Image Collage */}
          <div className="lg:col-span-6 relative flex items-center justify-center py-6">
            ...
            >
              <img
                ...
                alt="Candid celebration photograph"
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-20 grid grid-cols-1 lg:grid-cols-12 gap-8 border-b border-sand-dark/15">
        <div className="lg:col-span-5 text-left space-y-2">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl text-charcoal leading-tight">
            Unposed. Unplanned.<br />True moments.
          </h2>
        </div>
        <div className="lg:col-span-7 text-left space-y-4">
          <p className="font-sans text-sm sm:text-base text-mud/85 leading-relaxed">
            Candid photography is all about capturing the genuine, unscripted and heartfelt moments of your celebration. We blend in, observe and capture your story as it naturally unfolds — real, raw and beautiful.
          </p>
          <p className="font-tamil font-normal text-base text-terracotta/80 leading-relaxed italic">
            “இயல்பான தருணங்கள் தான், என்றென்றும் நினைவில் நிற்பவை.”
          </p>
        </div>
      </section>
      ...
      {/* Featured Image / Editorial Break */}
          ...
          <div className="border border-sand-dark/25 p-2 bg-[#fffdf8] shadow-md">
            <div className="h-[40vh] md:h-[55vh] overflow-hidden relative">
              <img
                ...
                alt="Exchange of garlands candid frame"
                className="w-full h-full object-cover"
              />
            </div>
          </div>
      ...
      {/* Traditional Wedding Moments Gallery */}
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-20 border-b border-sand-dark/15">
        <div className="text-center max-w-xl mx-auto mb-16 space-y-2">
          <h2 className="font-serif text-3xl sm:text-4xl text-charcoal tracking-wide">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-20 border-b border-sand-dark/15">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
          {[
            { num: "01", title: "REAL EMOTIONS", desc: "No fake poses—just natural smiles, tears, and pure joy." },
            { num: "02", title: "UNOBTRUSIVE FEEL", desc: "We shoot silently without disrupting the flow of your wedding." },
            { num: "03", title: "STORYTELLING DETAILS", desc: "Every smile, tear, and ritual documented in high detail." },
            { num: "04", title: "FOREVER MEMORIES", desc: "Timeless frames that you will cherish for generations." }
          ].map((benefit) => (
      ...
      <section className="py-24 max-w-3xl mx-auto text-center px-4 space-y-6">
        ...
        <div className="pt-4">
          <button
            onClick={() => navigate("/contact", { state: { fromService: "Candid Photography" } })}
